...
urlpatterns = [
    ...
    path('empresa/<int:empresa_id>/relacionamento/<int:rel_id>/editar/',views.editar_relacionamento, name='empresa_editar_relacionamento'),
    ...
    path("evento/<int:evento_id>/rodadas/processando/", views.rodadas_processando, name="rodadas_processando"),
    path("evento/<int:evento_id>/vendedor/<int:vendedor_id>/rodadas/", views.rodadas_do_vendedor, name="rodadas_do_vendedor"),
